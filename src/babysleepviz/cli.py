...
from .visualize import load_config as load_viz_config
...
def parse_cli():
    ...
    parser.add_argument(
        ...
        "--config",
        type=str,
        default="configs/huckleberry.yaml",
    ...
    parser.add_argument(
        "--bucket-minutes", type=int, default=5, help="Size of time buckets in minutes (default: 5)"
    )
    ...
    if not input_path.exists():
        ...
        print(
            "Put your export in local/ or use sample data: babysleepviz-parse local/sample_huckleberry.csv"
        )
        return 1
...
def main_cli():
    ...
    parser.add_argument(
        "input", type=str, help="Input CSV file from baby tracking app (e.g., Huckleberry export)"
    )
    parser.add_argument(
        "-o",
        "--output",
...
def help_cli():
    ...
    print(
        "                          Example: babysleepviz data.csv --day-zero 2024-01-15 -o output.png"
    )
    print()
    ...
    print(
        "                          Example: babysleepviz-render buckets.csv --day-zero 2024-01-15"
    )
    print()
