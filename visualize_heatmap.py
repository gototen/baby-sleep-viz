#!/usr/bin/env python3
"""
Generate a layered heatmap visualization of baby sleep, feeding, and medication data.

This script reads time-bucketed data (from sleep_buckets.py) and creates a beautiful
visualization showing patterns over time.
"""
...
def create_visualization(
    ...
    day_width = 6
    day_padding = 2
    cols_per_day = day_width + day_padding
    separator_padding = 4
    ...
    # 9am = 2 hours after 7am start
    # 5pm = 10 hours after 7am start
    # midnight = 17 hours after 7am start
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate heatmap visualization of baby sleep, feeding, and medication data'
    )
    parser.add_argument(
    ...
    if not input_path.exists():
        ...
        print("First run: python sleep_buckets.py <your_data.csv>")
        return 1
