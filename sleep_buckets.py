#!/usr/bin/env python3
"""
Parse Huckleberry CSV exports into time-bucketed data for visualization.

This script converts raw sleep/feed/meds data into 5-minute time buckets,
...
def get_minute_of_day(ts: datetime, day_start_hour: int = 7) -> int:
    """Get minute of day relative to day boundary (0 = day_start_hour:00)."""
...
def parse_data(
    ...
    """
    Parse Huckleberry CSV and convert to time-bucketed format.
...
def main():
    parser = argparse.ArgumentParser(
        description='Parse Huckleberry CSV exports into time-bucketed data for visualization'
    )
    parser.add_argument(
    ...
    if not input_path.exists():
        ...
        print("Put your export in local/ or use sample data: python sleep_buckets.py local/sample_huckleberry.csv")
        return 1
